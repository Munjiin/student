							...
							<c:forEach var="question" items="${qlist}">
								<tr class="odd gradeX">
									...
									<td><c:if test="${question.time > 0}">
											<a
												href="understand?page=${pageMaker.pageDTO.page}&qno=${question.qno}&mno=${question.mno}">
												${question.question}</a>
										</c:if> <c:if test="${question.time <= 0}">
											<a
												href="response?page=${pageMaker.pageDTO.page}&qno=${question.qno}&mno=${question.mno}">
